# Contributing to Falcon Measurement Lib

Help wanted! We'd love your contributions to Falcon Measurement Library.
...
Please don't open a GitHub issue for questions about how to use `falcon-measurement-lib`, as the goal is to use issues for managing bugs and feature requests. Issues that are related to general support will be closed and redirected to [discussions](https://github.com/falcon-autotuning/falcon-measurement-lib/discussions).

For all support related questions, please [open a discussion post](https://github.com/falcon-autotuning/falcon-measurement-lib/discussions/new/choose).

## <a id="bugs"></a> Found a Bug?

If you've identified a bug in `falcon-measurement-lib`, please [submit an issue](#issue) to our GitHub repo: [falcon-autotuning/falcon-measurement-lib](https://github.com/falcon-autotuning/falcon-measurement-lib/issues/new). Please also feel free to submit a [Pull Request](#pr) with a fix for the bug!
...
New issues can be created with in our [GitHub repo](https://github.com/falcon-autotuning/falcon-measurement-lib/issues/new).
...
By contributing your code, you agree to license your contribution under the terms of the [BSDv3 License](LICENSE).
